...
var FileItem = GObject.registerClass({
    ...
    _onAddToFavoritesClicked() {
        AppFavorites.getAppFavorites().addFavorite(this._file.get_basename());
    }
    ...
    _recreateMenu() {
        ...
        this._menu.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());
        if (this._isValidDesktopFile)
            this._menu.addAction(_('Add to Favorites'), () => this._onAddToFavoritesClicked());
